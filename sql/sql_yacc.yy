      ...
      | TDBCTL_SYM CREATE NODE_SYM WRAPPER_SYM
        ident_or_text OPTIONS_SYM '(' server_options_list ')' opt_with_schema
        {
          ...
          Lex->tc_do_grants = TRUE;
			    Lex->tc_flush_type = Lex->tc_with_schema ? FLUSH_ROUTING_FOR_CREATE_NODE : FLUSH_ALL_ROUTING;
        }
      | TDBCTL_SYM ALTER NODE_SYM ident_or_text OPTIONS_SYM '(' server_options_list ')' opt_with_sync opt_force
        {
          ...
          Lex->tc_do_grants = TRUE;
			    Lex->tc_flush_type = Lex->tc_with_sync ? SYNC_ROUTING_FOR_ALTER_NODE : FLUSH_ALL_ROUTING;
        }
      | TDBCTL_SYM DROP NODE_SYM if_exists ident_or_text opt_force
        {
          Lex->sql_command = TC_SQLCOM_DROP_NODE;
          Lex->server_options.m_server_name= $5;
          Lex->m_sql_cmd=
...
opt_with_schema:
         /* empty */ {  Lex->tc_with_schema = FALSE; }
         |WITH DATABASE
         {
