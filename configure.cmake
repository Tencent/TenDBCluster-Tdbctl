...
IF(UNIX)
  ...
  # Check if WITH_STATIC_LIBCRYPT is requested
  # Default is static (WITH_STATIC_LIBCRYPT=ON or undefined)
  IF(NOT DEFINED WITH_STATIC_LIBCRYPT OR WITH_STATIC_LIBCRYPT)
    MESSAGE(STATUS "Looking for static libcrypt library")
    FIND_LIBRARY(LIBCRYPT_STATIC NAMES libcrypt.a PATHS /usr/lib /usr/lib64 /lib /lib64 /usr/local/lib /usr/local/lib64)
    IF(LIBCRYPT_STATIC)
      SET(LIBCRYPT ${LIBCRYPT_STATIC})
      SET(HAVE_LIBCRYPT 1)
      MESSAGE(STATUS "Found static libcrypt: ${LIBCRYPT_STATIC}")
    ELSE()
      MESSAGE(FATAL_ERROR "Static libcrypt requested but libcrypt.a not found. Install libcrypt-static or use --no-static-libcrypt")
    ENDIF()
  ELSE()
    MESSAGE(STATUS "Using system dynamic libcrypt library")
