...
enum enum_sql_command {
  ...
  TC_SQLCOM_START,
  TC_SQLCOM_FLUSH_ROUTING,
  TC_SQLCOM_CREATE_SERVER,
  TC_SQLCOM_DROP_SERVER,
  TC_SQLCOM_ALTER_SERVER,
  TC_SQLCOM_CREATE_TABLE_WITH_SELECT,
  TC_SQLCOM_CREATE_TABLE_WITH_CONNECT_STRING,
  TC_SQLCOM_CREATE_TABLE_WITH_TABLE_COMMENT,
  TC_SQLCOM_CREATE_TABLE_WITH_FIELD_CHARSET,
