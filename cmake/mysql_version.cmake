...
MACRO(GET_MYSQL_VERSION)
  ...
  MYSQL_GET_CONFIG_VALUE("TDBCTL_VERSION_MAJOR" TDBCTL_MAJOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("TDBCTL_VERSION_MINOR" TDBCTL_MINOR_VERSION)
  MYSQL_GET_CONFIG_VALUE("TDBCTL_VERSION_PATCH" TDBCTL_PATCH_VERSION)
  ...
  # Calculate TDBCTL version ID
  IF(NOT DEFINED TDBCTL_MAJOR_VERSION OR
     NOT DEFINED TDBCTL_MINOR_VERSION OR
     NOT DEFINED TDBCTL_PATCH_VERSION)
    MESSAGE(FATAL_ERROR "TDBCTL_VERSION parameters cannot be parsed from MYSQL_VERSION file.")
  ENDIF()
  
  MATH(EXPR TDBCTL_VERSION_ID
    "900000 + 10000*${TDBCTL_MAJOR_VERSION} + 100*${TDBCTL_MINOR_VERSION} + ${TDBCTL_PATCH_VERSION}")
